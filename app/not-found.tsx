  ...
  return (
    <>
      <section className='relative z-10 pt-36 pb-16 md:pb-20 lg:pt-[180px] lg:pb-28'>
          ...
          <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4'>
              <div className='mx-auto max-w-[530px] text-center'>
                <div className='mx-auto mb-9 text-center'>
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor='#EB0A93' stopOpacity='0' />
                        <stop offset='1' stopColor='#EB0A93' />
                      </linearGradient>
                      <linearGradient
                ...
                <p className='mb-10 text-base font-medium leading-relaxed text-black sm:text-lg sm:leading-relaxed'>
        ...
        <div className='absolute left-0 bottom-0 z-[-1] hidden sm:block'></div>
        <div className='absolute top-0 right-0 z-[-1] hidden sm:block'></div>
      </section>
    </>
  )
}
